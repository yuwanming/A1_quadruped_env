...
from a1_description.a1_bound_configuration import *
...
class A1(gym.Env):
    ...
    def task_reward(self):
        ...
        base_x_vel_tar = 1.0
        base_y_vel_tar = 0.0
        base_xy_vel_tar = np.array([0.75, 0.0])
        base_z_vel_tar = 0.0
        ...
        base_xy_vel_reward = math.exp(math.log(alpha)*(base_xy_vel_err/0.5)**2)
        base_x_vel_reward = math.exp(math.log(alpha)*(base_x_vel_err/0.5)**2)
        base_y_vel_reward = math.exp(math.log(alpha)*(base_y_vel_err/0.5)**2)
        base_z_vel_reward = math.exp(math.log(alpha)*(base_z_vel_err/0.5)**2)
    ...
    def imitation_reward(self):
        ...
        if gait_phase >= 0 and gait_phase < gap:
            if (fl_ground_contact == False and fr_ground_contact == False and rl_ground_contact == False and rr_ground_contact == False): #allow double contact
                contact_term = 2
            else:
                contact_term = 0
        elif gait_phase >= gap and gait_phase < 0.5:
            if (fl_ground_contact == True and fr_ground_contact == True and rl_ground_contact == False and rr_ground_contact == False):
                contact_term = 2
            else:
                contact_term = 0
            ...
            if (fl_ground_contact == False and fr_ground_contact == False and rl_ground_contact == True and rr_ground_contact == True):
                contact_term = 2
            else:
                contact_term = 0
        else:
