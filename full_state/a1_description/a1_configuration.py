...
class A1Config():
    ...
    #keypose initialization
        ...
        q_nom = dict([
            ...
            ("FR_lower_leg_2_upper_leg_joint", 0.66),
            ("FL_hip_motor_2_chassis_joint", 0),
        ...
        # crouch
        base_pos_nom = [0, 0, 0.21]
        base_orn_nom = euler_to_quat(0, 0, 0)
        q_nom = dict([
            ("FR_hip_motor_2_chassis_joint", 0),
            ("FR_upper_leg_2_hip_motor_joint", -1.46),
            ("FR_lower_leg_2_upper_leg_joint", 2.09),
            ("FL_hip_motor_2_chassis_joint", 0),
            ("FL_upper_leg_2_hip_motor_joint", -1.46),
            ("FL_lower_leg_2_upper_leg_joint", 2.09),
            ("RR_hip_motor_2_chassis_joint", 0),
            ("RR_upper_leg_2_hip_motor_joint", -1.46),
            ("RR_lower_leg_2_upper_leg_joint", 2.09),
            ("RL_hip_motor_2_chassis_joint", 0),
            ("RL_upper_leg_2_hip_motor_joint", -1.46),
            ("RL_lower_leg_2_upper_leg_joint", 2.09),
        ])
        self.key_pose.append([base_pos_nom, base_orn_nom, q_nom])
