...
from a1_description.a1_pace_configuration import *
...
class A1(gym.Env):
    ...
    def imitation_reward(self):
        ...
        if gait_phase >= 0 and gait_phase < gap:
            ...
            if (fl_ground_contact == False and fr_ground_contact == True and rl_ground_contact == False and rr_ground_contact == True):
                contact_term = 2
            else:
                contact_term = 0
            ...
            if (fl_ground_contact == True and fr_ground_contact == False and rl_ground_contact == True and rr_ground_contact == False):
                contact_term = 2
            else:
                contact_term = 0
        else:
