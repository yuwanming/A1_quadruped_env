...
from SAC.SAC.configuration_pace import *
from SAC.agent.agent_SAC import *
from SAC.common.logger import logger

from a1_pace_phase_env_key_state import A1
...
def main():
    ...
    dir_path = parentdir + '/SAC/SAC/SAC/record/a1/pace/' + args.folder
