...
class A1Config():
    ...
    #keypose initialization for galloping
        self.key_pose = []
        # # gallop 1
        # '''
        # RL  x  |FL   
        ...
        q_nom = dict([
            ...
            ("FR_lower_leg_2_upper_leg_joint", 1.75),
            ("FL_hip_motor_2_chassis_joint", 0),
            ("FL_upper_leg_2_hip_motor_joint", -1.24),
            ("FL_lower_leg_2_upper_leg_joint", 1.75),
            ("RR_hip_motor_2_chassis_joint", 0),
            ("RR_upper_leg_2_hip_motor_joint", -1.24),
            ("RR_lower_leg_2_upper_leg_joint", 1.75),
            ("RL_hip_motor_2_chassis_joint", 0),
            ("RL_upper_leg_2_hip_motor_joint", -0.785),
            ("RL_lower_leg_2_upper_leg_joint", 1.57),
        ])
        ...
        q_nom = dict([
            ...
            ("RL_lower_leg_2_upper_leg_joint", 1.75),
        ])
        self.key_pose.append([base_pos_nom, base_orn_nom, q_nom])
        ...
        q_nom = dict([
            ("FR_hip_motor_2_chassis_joint", 0),
            ("FR_upper_leg_2_hip_motor_joint", -1.24),
            ("FR_lower_leg_2_upper_leg_joint", 1.694),
            ("FL_hip_motor_2_chassis_joint", 0),
            ("FL_upper_leg_2_hip_motor_joint", -1.24),
            ("FL_lower_leg_2_upper_leg_joint", 1.694),
            ("RR_hip_motor_2_chassis_joint", 0),
            ("RR_upper_leg_2_hip_motor_joint", -0.44),
            ("RR_lower_leg_2_upper_leg_joint", 1.684),
            ("RL_hip_motor_2_chassis_joint", 0),
            ("RL_upper_leg_2_hip_motor_joint", -0.44),
            ("RL_lower_leg_2_upper_leg_joint", 1.684),
        ])
        self.key_pose.append([base_pos_nom, base_orn_nom, q_nom])
