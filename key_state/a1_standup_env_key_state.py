...
class A1(gym.Env):
    ...
    def __init__(self,
        ...
        self.stateNumber = 3+len(self.controlled_joints)
        ...
        self.prev_base_quat = np.array([0,0,0,0])
    ...
    def getObservation(self):
        ...
        x_observation[0] = gravityPosInBase[0]
        x_observation[1] = gravityPosInBase[1]
        x_observation[2] = gravityPosInBase[2]
