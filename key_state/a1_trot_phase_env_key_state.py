...
class A1(gym.Env):
    ...
    def __init__(self,
        ...
        self.stateNumber = 8+len(self.controlled_joints)
    ...
    def getObservation(self):
        ...
        x_observation[0] = phase_sin
        x_observation[1] = phase_cos
        ...
        x_observation[2] = gravityPosInBase[0]
        x_observation[3] = gravityPosInBase[1]
        x_observation[4] = gravityPosInBase[2]
        ...
        x_observation[5] = base_pos_vel_yaw[0][0]
        x_observation[6] = base_pos_vel_yaw[0][1]
        x_observation[7] = base_pos_vel_yaw[0][2]
    ...
    def getFilteredObservation(self):
        ...
        observation_filtered[0:2] = self.unfiltered_phase
    ...
    def performFiltering(self):
        ...
        self.unfiltered_phase = np.array([observation[0], observation[1]])
